...
function start() {
	...
	tlPlaerys.to(".draw_shoot_player", TIME_SHOOT, { x: 0, y: 0, ease: Power4.easeOut }, 'player');
	// tlPlaerys.from(".draw_shoot_lines", TIME_SHOOT*.85, {x:"+=10", y:"+=70", ease:Power4.easeOut}, 'player')

	tlPlaerys.add('defend', 0);
	tlPlaerys.to(".draw_defend_player", TIME_SHOOT, { x: 0, y: 0, ease: Power4.easeOut }, 'defend');
